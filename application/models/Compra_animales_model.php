...
class Compra_animales_model extends CI_Model
{
    ...
    public function getCompraAnimal($id_compra_animales)
    {
        ...
        $this->db->join('intermediario ie','ie.id_intermediario = ca.id_intermediario');
        ...
        $this->db->join('persona pg','pg.id_persona = e.id_persona');
        $this->db->join('persona pie','pie.id_persona = e.id_persona');
        $this->db->join('persona ptr','ptr.id_persona = e.id_persona');
        $this->db->where('ca.estado','1');
