            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo base_url(); ?>Formulario_Empleados/Empleado/guardarEmpleado" id="empleado" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group <?php echo !empty(form_error("apellidos")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="text" name="apellidos" value="<?php echo set_value('apellidos') ?>" id=apellidos required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("ci")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number" name="ci" value="<?php echo set_value('ci') ?>" id=ci required="required" class="form-control col-md-3 col-xs-12">
                    ...
                    <div class="form-group <?php echo !empty(form_error("telefono")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number" name="telefono" value="<?php echo set_value('telefono') ?>" id=telefono required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("tipo_cargo")) ? 'has-error' : ''; ?>">
                         ...
                         <div class="col-md-4 col-sm-6 col-xs-12">
                             <select name="tipo_cargo" id="tipo_cargo" required class="form-control col-md-3 col-xs-12">
                                 <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <textarea rows="3" type="text" name="direccion" value="<?php echo set_value('direccion') ?>" id=direccion class="form-control col-md-3 col-xs-12" placeholder=""></textarea>
                    ...
                    <div class="form-group <?php echo !empty(form_error("fecha_ingreso")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="date" name="fecha_ingreso" value="<?php echo set_value('fecha_ingreso') ?>" id=fecha_ingreso required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("fecha_salida")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="date" name="fecha_salida" value="<?php echo set_value('fecha_salida') ?>" id=fecha_salida  class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number" name="sueldo" value="<?php echo set_value('sueldo') ?>" id=sueldo required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("afp_empleado")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number" readonly  name="afp_empleado" value="<?php echo set_value('afp_empleado') ?>" id=afp_empleado required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("afp_empleador")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number" readonly  name="afp_empleador" value="<?php echo set_value('afp_empleador') ?>" id=afp_empleador required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("caja_nacional")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number"  readonly name="caja_nacional" value="<?php echo set_value('caja_nacional') ?>" id=caja_nacional required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo_liquido")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number"  readonly name="sueldo_liquido" value="<?php echo set_value('sueldo_liquido') ?>" id=sueldo_liquido required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo_total")) ? 'has-error' : ''; ?>">
                        <label for="sueldo_total" class="control-label col-md-3 col-sm-3 col-xs-12">Sueldo total empleado: </label>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="number"  readonly name="sueldo_total" value="<?php echo set_value('sueldo_total') ?>" id=sueldo_total required="required" class="form-control col-md-3 col-xs-12" placeholder="">
                             ...
                             <?php if (!empty($empleados)) : ?>
                                 <?php foreach ($empleados as $empleado) : ?>
                                     ...
                                     <tr>
                                         ...
                                         <td><?php echo number_format($empleado->afp_empleado, 2) ; ?></td>   
                                         <td><?php echo number_format($empleado->afp_empleador, 2); ?></td>
                                         <td><?php echo number_format($empleado->caja_nacional, 2) ; ?></td>
                                         <td><?php echo number_format($empleado->sueldo_liquido, 2) ; ?></td>
                                         <td><?php echo number_format($empleado->sueldo_total, 2) ; ?></td>
