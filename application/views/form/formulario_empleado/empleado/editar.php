                ...
                <form method="POST" action="<?php echo base_url(); ?>Formulario_Empleados/Empleado/actualizarEmpleado" id="contrato_empleado" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group <?php echo !empty(form_error("nombre")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="nombre" value="<?php echo !empty(form_error("nombre")) ? set_value("nombre") : $empleado->nombres ?>" id=nombre required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("apellidos")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="apellidos" value="<?php echo !empty(form_error("apellidos")) ? set_value("apellidos") : $empleado->apellidos ?>" id=apellidos required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("ci")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="ci" value="<?php echo !empty(form_error("ci")) ? set_value("ci") : $empleado->carnet_identidad ?>" id=ci required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("telefono")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="telefono" value="<?php echo !empty(form_error("telefono")) ? set_value("telefono") : $empleado->telefono ?>" id=telefono required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="tipo_cargo" id="tipo_cargo" required="required" class="form-group col-md-7 col-xs-12">
                    ...
                    <div class="form-group <?php echo !empty(form_error("direccion")) ? 'has-error' : ''; ?>">
                        <label for="direccion" class="control-label col-md-3 col-sm-3 col-xs-12">Direciion <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea rows="3" type="text" name="direccion"  id=direccion required="required" class="form-group col-md-7 col-xs-12" placeholder=""><?php echo !empty(form_error("direccion")) ? set_value("direccion") : $empleado->direccion ?></textarea>
                    ...
                    <div class="form-group <?php echo !empty(form_error("fecha_ingreso")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="date" name="fecha_ingreso" value="<?php echo !empty(form_error("fecha_ingreso")) ? set_value("fecha_ingreso") : $empleado->fecha_ingreso ?>" id=fecha_ingreso required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("fecha_salida")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="date" name="fecha_salida" value="<?php echo !empty(form_error("fecha_salida")) ? set_value("fecha_salida") : $empleado->fecha_salida ?>" id=fecha_salida  class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" name="sueldo" value="<?php echo !empty(form_error("sueldo")) ? set_value("sueldo") : $empleado->sueldo ?>" id=sueldo required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("afp_empleado")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" readonly name="afp_empleado" value="<?php echo !empty(form_error("afp_empleado")) ? set_value("afp_empleado") : $empleado->afp_empleado ?>" id=afp_empleado required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("afp_empleador")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" readonly name="afp_empleador" value="<?php echo !empty(form_error("afp_empleador")) ? set_value("afp_empleador") : $empleado->afp_empleador ?>" id=afp_empleador required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("caja_nacional")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" readonly name="caja_nacional" value="<?php echo !empty(form_error("caja_nacional")) ? set_value("caja_nacional") : $empleado->caja_nacional ?>" id=caja_nacional required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo_liquido")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" readonly name="sueldo_liquido" value="<?php echo !empty(form_error("sueldo_liquido")) ? set_value("sueldo_liquido") : $empleado->sueldo_liquido ?>" id=sueldo_liquido required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group <?php echo !empty(form_error("sueldo_total")) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" readonly name="sueldo_total" value="<?php echo !empty(form_error("sueldo_total")) ? set_value("sueldo_total") : $empleado->sueldo_total ?>" id=sueldo_total required="required" class="form-group col-md-7 col-xs-12" placeholder="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="<?php echo site_url("Formulario_Empleado/Empleados") ?>" class="btn btn-primary btn-flat">Volver</a>
