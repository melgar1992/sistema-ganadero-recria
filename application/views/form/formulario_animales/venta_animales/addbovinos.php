  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          <form method="POST" action="<?php echo base_url(); ?>Formulario_Animales/Venta_animales/ventaAnimalesBovinos" id="venta_animales_bovinos" class="form-horizontal form-label-left">
              <!-- Default box -->
              <div class="box">
