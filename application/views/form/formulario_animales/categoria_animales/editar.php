             ...
             <div class="box-body">
                 ...
                 <form method="POST" action="<?php echo base_url();?>Formulario_Animales/Categoria_animales/actualizarCategoriaAnimal" id="categorias" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group <?php echo !empty(form_error("nombre"))?'has-error':'';?>">
                         ...
                         <input type="text" name="nombre" id=nombre value="<?php echo !empty(form_error("nombre"))? set_value("nombre"):$categorias->nombre ?>" required="required" class="form-group col-md-7 col-xs-12" > 
