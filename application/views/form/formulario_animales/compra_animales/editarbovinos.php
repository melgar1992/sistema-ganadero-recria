                    ...
                    <div class="form-group">
                        ...
                        <div class='col-md-3 col-sm-6 col-xs-12'>
                            ...
                            <div class="input-group <?php echo !empty(form_error("intermediario")) ? 'has-error' : ''; ?>">
                                <input type="hidden" name="id_intermediario" value="<?php echo !empty(form_error('id_intermediario')) ? set_value('id_intermediario') : $compra_animal->id_intermediario ?>" id="id_intermediario">
                                <input type="text" class="form-control" value="<?php echo !empty(form_error('intermediario')) ? form_error('intermediario') : $compra_animal->nombre_intermediario ?>" placeholder="Intermediario" readonly name="intermediario" id="intermediario">
                                <span class="input-group-btn">
                        ...
                        <div class='col-md-3 col-sm-6 col-xs-12'>
                            <div class='input-group'>
                                ...
                                <input type="number" min="0" max='10' value="<?php echo !empty(form_error('comision')) ? set_value('comision') : $compra_animal->comision ?>" class='form-control' name="comision" id="comision" placeholder="%">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
