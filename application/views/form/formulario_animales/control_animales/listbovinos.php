...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <h3 class="box-title">Formulario de Control de Animales Bovinos</h3>
                                ...
                                <?php if (!empty($Control_animales)) : ?>
                                    <?php foreach ($Control_animales as $Control_animal) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>Formulario_Animales/control_animales/editarBovinos/<?php echo $Control_animal->id_detalle_venta_animales; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
