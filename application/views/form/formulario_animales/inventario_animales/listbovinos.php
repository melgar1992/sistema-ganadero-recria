    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Formulario Inventario Animales Bovinos</h3>
            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo base_url(); ?>Formulario_Animales/inventario_animales/guardarBovino" id="inventario_animal" class="form-horizontal form-label-left">
                                ...
                                <?php if (!empty($stock_estancias_bovinos)) : ?>
                                    <?php foreach ($stock_estancias_bovinos as $stock_estancia_bovinos) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>Formulario_Animales/inventario_animales/editarbovinos/<?php echo $stock_estancia_bovinos->id_animal; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
