...
class Tipo_cargo extends BaseController
{
    public function index()
    {
        ...
        $this->loadView('Tipo_cargo', '/form/formulario_empleado/tipo_cargo/list', $data);
    }
    public function guardartipo_cargo()
    {
        ...
        $this->form_validation->set_rules(
            ...
            array(
                'required',
                array('validarCargo', array($this->Tipo_cargo_model, 'validarCargo'))
            ),
            array('validarCargo' => 'El cargo ya existe!')
        );
    ...
    public function editar($id_tipo_cargo)
    {
        ...
        $this->loadView('Tipo_cargo', '/form/formulario_empleado/tipo_cargo/editar', $data);
    }
