$(document).ready(function() {
    ...
    $(document).on("keyup", "#tbegresos input.cantidad", function() {
    ...
    $(document).on("keyup", "#tbegresos input.precio_unitario", function() {
    ...
    $(document).on('click', '.btn-borrar', function() {
        ...
        Swal.fire({
            ...
            text: "Una vez elimina el Egreso Gasto Variable tambien se eliminaran todos los datos relacionados con el mismo!",
            type: 'warning',
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: base_url + 'Formulario_Egresos/Egreso_gasto_variable/borrar/' + id,
                    type: 'POST',
...
function sumar() {
    total = 0;
    $("#tbegresos  tbody tr").each(function() {
